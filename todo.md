...
- [x] Inspect the existing Vite build scripts, static asset paths, and deployment configuration. Configured a clean static build pipeline and Vercel configuration.
